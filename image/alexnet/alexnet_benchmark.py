...
def inference(images):
  ...
  """
  parameters = []
  # 32x32 --enlarge--> 256x256 --extract random--> 224x224
  # conv1 [batch,56,56,64]
  ...
  # pool1 [batch, 27,27, 64]
  pool1 = tf.nn.max_pool(lrn1, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='VALID', name='pool1')
  print_activations(pool1)

  # conv2 [batch,27,27,192]
  ...
  # pool2 [batch, 13,13, 192]
  pool2 = tf.nn.max_pool(lrn2, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='VALID', name='pool2')
  print_activations(pool2)

  # conv3 [batch, 13,13, 384]
...
def run_benchmark():
  ...
  with tf.Graph().as_default():
    ...
    # type of gpu allocation strategy: "Best-fit with coalescing"
